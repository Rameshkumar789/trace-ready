...
from bellwether_backend.audit_engine.cte_classification import build_phase10c_cte_hardening
...
class Phase11ApprovedRuleExecutionTest(unittest.TestCase):
    ...
    def test_phase11_artifacts_include_workbook_file(self) -> None:
        from bellwether_backend.audit_engine.rule_execution import write_phase11_rule_execution_artifacts
...
class TlcLineageAndPlaceholderTest(unittest.TestCase):
    ...
    def test_kde_contracts_cover_full_movement_kdes_and_cooling(self):
        from bellwether_backend.audit_engine.rule_execution import _load_kde_check_contracts
...
class ExemptionClaimEvaluationTest(unittest.TestCase):
    ...
    def setUp(self):
        from bellwether_backend.audit_engine.rule_execution import _load_exemption_rules

        self.rules = _load_exemption_rules()

    def _checks(self, rows):
        from bellwether_backend.audit_engine.rule_execution import check_exemption_claims
