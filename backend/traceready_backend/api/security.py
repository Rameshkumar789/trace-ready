...
from traceready_backend.api.config import ServiceSettings
...
def require_internal_token(
    ...
    x_traceready_internal_token: str | None = Header(default=None),
) -> None:
    ...
    supplied_token = x_traceready_internal_token or _extract_bearer_token(authorization)
