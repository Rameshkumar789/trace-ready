...
- `ingestion/ingest.py`
- `ingestion/traceready_ingestion/fetchers/ecfr_fetcher.py`
- `ingestion/traceready_ingestion/fetchers/fda_fetcher.py`
- `ingestion/traceready_ingestion/fetchers/federal_register_fetcher.py`
- `ingestion/traceready_ingestion/fetchers/pdf_importer.py`
- `ingestion/traceready_ingestion/extractors/html_extractor.py`
- `ingestion/traceready_ingestion/extractors/pdf_extractor.py`
- `ingestion/traceready_ingestion/extractors/table_extractor.py`
- `ingestion/traceready_ingestion/chunking/legal_chunker.py`
- `ingestion/traceready_ingestion/chunking/citation_anchor.py`
- `ingestion/traceready_ingestion/drafting/rule_card_drafter.py`
- `ingestion/traceready_ingestion/drafting/kde_drafter.py`
- `ingestion/traceready_ingestion/drafting/schemas.py`
- `ingestion/traceready_ingestion/storage/db.py`
- `ingestion/traceready_ingestion/storage/artifacts.py`
- `ingestion/traceready_ingestion/versioning/hashing.py`
- `ingestion/traceready_ingestion/versioning/source_versioning.py`
